  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="<?php echo e(request()->is('guest') ? 'active' : ''); ?>"><a href="transaction"><i class="icon-barcode"></i><span>Dashboard</span> </a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <hr>
          ...
          <!-- <form action="<?php echo e(route('guest-stock-request')); ?>" method="post">
          ...
          <div class="form-row">
                    ...
                    <select name="request_stock_name[]" id="stock_id" class="req">
                      ...
                      <?php $__currentLoopData = $stock; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stocks): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($stocks->stock_name); ?>" data-price="<?php echo e($stocks->stock_cost); ?>">
                          <?php echo e($stocks->stock_name); ?> Price: <?php echo e($stocks->stock_cost); ?>
            ...
            <div class="col-md-1 mb-1">
              ...
              <input type="text" class="form-control unt" id="price" name="request_stock_price[]" value="<?php echo e(old('request_stock_price')); ?>" placeholder="0" readonly>
    ...
    <div class="row" style="margin-top:80px; margin-bottom:80px;">
        ...
        <table id="invent_table" class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo e($stocks['stock_name']); ?> </td>
                    <td><?php echo e($stocks['stock_type']); ?></td>
                    <td><?php echo e($stocks['stock_description']); ?></td>
                    <td><?php echo e($stocks['stock_format']); ?></td>
                    <td><?php echo e($stocks['stock_count']); ?></td>
                    <td><?php echo e($stocks['stock_cost']); ?></td>                  
                  </tr>
...
</html><?php /**PATH /home/devcrewph/public_html/sac/resources/views/guest/index.blade.php ENDPATH**/ ?>