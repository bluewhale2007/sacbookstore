      ...
      <div class="row">
        <span class="span12" style="margin-bottom: 35px;">
            <div class="alert">
              ...
              <h1>Total Transaction: {{$transactionCount}}</h1>
              <h1>Sucessful Transaction: {{$successfulCount}}</h1>
              <h1>Pending Transaction: {{$pendingCount}}</h1>
              <h1>Declined Transaction: {{$declinedCount}}</h1>
        </span>
